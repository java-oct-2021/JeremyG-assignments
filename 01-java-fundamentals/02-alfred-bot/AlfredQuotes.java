...
public class AlfredQuotes {
    ...
    */
    public String guestGreeting(String name, String dayPeriod) {
        String greeting = String.format("Good" + dayPeriod + ", " + name + "." + "Lovely to see you.");
        return greeting;
    }
    /* 
    * Inputs: None
...
    */
    ...
    public String emergencyCall(String emergency) {
        int help = emergency.indexOf("911");

        if(help > -1) {
            return "Bruce, you are needed.";
        }
        else {
            return "You are free to do whatever you wish, sir.";
        }
    }
}
