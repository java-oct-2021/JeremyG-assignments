package com.jeremy.dojooverflow.controllers;
...
import com.jeremy.dojooverflow.services.DoService;

@Controller
public class HomeController {
	private final DoService s;

	public HomeController(DoService s) {
		this.s = s;
	}
